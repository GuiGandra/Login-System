...
sao = PhotoImage(file='Imagens/sao.png')

#=======Widgets============
LeftFrame = Frame(jan, width=200, height=300, bg='CadetBlue', relief='raise')
LeftFrame.pack(side=LEFT)

RightFrame = Frame(jan, width=399, height=300, bg='DarkSlateGray', relief='raise')
RightFrame.pack(side=RIGHT)

saoLabel = Label(LeftFrame, image=sao, bg='CadetBlue')
saoLabel.place(x=3, y=-30)

KiritoLabel = Label(RightFrame, image=kirito, bg='DarkSlateGray')
KiritoLabel.place(x=50000, y=70)

kleinLabel = Label(RightFrame, image=klein, bg='DarkSlateGray')
kleinLabel.place(x=50000, y=120)

CongraLabel = Label(RightFrame, image=congra, bg='DarkSlateGray')
CongraLabel.place(x=50000, y=10)

LogoLabel = Label(LeftFrame, image=logo, bg='CadetBlue')
LogoLabel.place(x=-50, y=100)

UserLabel = Label(RightFrame, text="Username:", font=('Centur Gothic', 20), bg='DarkSlateGray', fg='WHITE')
UserLabel.place(x=5, y=100)

UserEntry = ttk.Entry(RightFrame, width=30)
UserEntry.place(x=145, y=110)
#
PassLabel = Label(RightFrame, text="Password:", font=('Centur Gothic', 20), bg='DarkSlateGray', fg='WHITE')
...
def Register():
    ...
    NomeLabel = Label(RightFrame, text='Name:', font=('Centur Gothic', 20), bg='DarkSlateGray', fg='White' )
    NomeLabel.place(x=5, y=38)
    NomeEntry= ttk.Entry(RightFrame, width=39)
    NomeEntry.place(x=90, y=49)

    EmailLabel = Label(RightFrame, text='Email:', font=('Centur Gothic', 20), bg='DarkSlateGray', fg='White')
